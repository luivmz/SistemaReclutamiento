...
(1, 'Postulante Demo', 'postulante@talento.edu', '999222333', 'Cursos basicos de Java', 'Java, HTML, trabajo en equipo', 'cv_demo.pdf', DATE '2026-05-15', 'EN_ENTREVISTA', 1, 2, false, 'Entrevista programada.'),
(2, 'Postulante Demo', 'postulante@talento.edu', '999222333', 'Apoyo administrativo academico', 'Excel, organizacion, comunicacion', 'cv_demo.pdf', DATE '2026-05-14', 'APROBADO', 2, 2, true, 'Entrevista aprobada.');

INSERT INTO entrevistas (id, tipo_entrevista, fecha, hora, lugar, modalidad, observacion, estado_entrevista, postulante_id) VALUES
(1, 'NORMAL', DATE '2026-05-20', TIME '09:00:00', 'Aula 201', 'PRESENCIAL', 'Entrevista inicial programada.', 'PROGRAMADA', 1),
(2, 'PSICOLOGICA', DATE '2026-05-21', TIME '10:30:00', 'Aula 202', 'PRESENCIAL', 'Buen desempeno en evaluacion psicologica.', 'REALIZADA', 2);
...
(1, 2, 'APROBADO', 90, 'Excelente actitud y comunicacion.', 'Continuar al proceso de contratacion.', TIMESTAMP '2026-05-21 11:30:00', 'Administrador Academico');
...
ALTER TABLE resultados_entrevista ALTER COLUMN id RESTART WITH 2;
